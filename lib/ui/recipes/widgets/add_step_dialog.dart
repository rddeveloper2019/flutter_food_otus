      ...
      child: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              const Text('Шаг рецепта', style: TextStyle(fontSize: 16)),
              ...
              AppInput(
                ...
                validator: (value) =>
                    value?.isEmpty == true ? 'Введите описание шага' : null,
              ),
              const SizedBox(height: 8),
              const Text('Длительность шага', style: TextStyle(fontSize: 10)),
              const SizedBox(height: 8),
              Row(
                children: [
                  Expanded(
